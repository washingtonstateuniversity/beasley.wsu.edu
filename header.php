...
<!--[if IE 9]>
<style type="text/css">
.row .column.flex-gallery {display:table;border-collapse:collapse;border:none;position: relative;z-index: 10;}.flex-gallery > * {float:none;display:table-row;text-align:center;}.flex-gallery p,.flex-gallery a,.flex-gallery img {float:none;display:table-cell;margin:0;}
</style>
<![endif]-->
</head>
